...
class Test_Orange_OCS_iOSTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        programCellViewModel = ProgramCellViewModel(with: Content(title: [Title(color: nil, type: "text", value: "HITMAN")], subtitle: "action, thriller", subtitlefocus: ["action, thriller"], imageurl: "/data_plateforme/program/35797/origin_hitmanxxxxxw0014384_2bvz3.jpg?size=small", fullscreenimageurl: "/data_plateforme/program/35797/origin_hitmanxxxxxw0014384_2bvz3.jpg?size=large", id: "HITMANXXXXXW0014384", detaillink: "/apps/v2/details/programme/HITMANXXXXXW0014384", duration: "PT1H28M55S", playinfoid: PlayInfo(hd: "8173B29F-E5FD-4AF0-2C6E-B48C3FACF486", sd: "8173B29F-E5FD-4AF0-2C6E-B48C3FACF486", uhd: nil)))
    ...
    func testProgramViewModelFetchData() {
        ...
        XCTAssertGreaterThan(programViewModel.programCellViewModels.count, 0)
    }
    ...
    func testProgramViewModelError() {
        ...
        XCTAssertEqual(programViewModel.programCellViewModels.count, 0)
    }
